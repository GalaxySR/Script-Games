...
local function PSDQ_fake_script() -- Insert.LocalScript 
...
coroutine.wrap(PSDQ_fake_script)()
local function RJGVN_fake_script() -- Main.Open 
...
coroutine.wrap(RJGVN_fake_script)()
local function VYYKQEN_fake_script() -- Aimbot.LocalScript 
...
coroutine.wrap(VYYKQEN_fake_script)()
local function RGYZGT_fake_script() -- ESP.LocalScript 
...
coroutine.wrap(RGYZGT_fake_script)()
